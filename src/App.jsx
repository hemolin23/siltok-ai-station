...
export default function App() {
  return <main className={styles.page}>
    ...
    <section className={styles.apply}><div><p>LET'S BUILD TOGETHER</p><h2>先加企微，<br/>再选择合作入口。</h2><span>产品体验请选择“内测申请”；拥有内容账号、商单报价、工作流或渠道资源的创作者与机构，请选择“商单 / 生态合作”。</span></div><div className={styles.applyCards}><div className={styles.qrMini}><img src={asset('enterprise-wechat-shigenjie-20260904.png')} alt="石根洁的企业微信二维码"/><b>石根洁 · 硅基词元</b></div><div className={styles.qrMini}><img src={asset('enterprise-wechat-linan-20260909.png')} alt="李楠的企业微信二维码"/><b>李楠 · 硅基词元</b></div><div className={styles.applyCard}><FileCheck2/><h3>产品内测申请</h3><p>真实任务、工具现状与可参与时间</p><a href={APPLY_URL} target="_blank" rel="noreferrer">填写内测表 <ArrowRight/></a></div><div className={styles.applyCard}><MessageSquareText/><h3>商单 / 生态合作</h3><p>填写账号信息，上传团队介绍、媒体资料包与报价文件</p><a href={COLLAB_URL} target="_blank" rel="noreferrer">填写合作表 <ArrowRight/></a></div></div></section>
